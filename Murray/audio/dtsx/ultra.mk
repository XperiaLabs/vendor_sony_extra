...
# DTS:X Path
LOCAL_DTSX := vendor/sony/extra/Murray/audio/dtsx

# Soong Namespace
PRODUCT_SOONG_NAMESPACES += \
    vendor/sony/extra/Murray/audio/dtsx

# SEPolicy
BOARD_VENDOR_SEPOLICY_DIRS += vendor/sony/extra/Murray/audio/dtsx/sepolicy/vendor
...
# DTS:X Config(s)
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/sony/extra/Murray/audio/dtsx/configs/perms,$(TARGET_COPY_OUT_SYSTEM)/etc) \
    $(call find-copy-subdir-files,*,vendor/sony/extra/Murray/audio/dtsx/configs/dts,$(TARGET_COPY_OUT_VENDOR)/etc)
